...
LDLIBSOPTIONS=-lwiringPi -lpigpio -lbcm2835 -lrt -lpthread

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/dynamixel

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/dynamixel: ${OBJECTFILES}
