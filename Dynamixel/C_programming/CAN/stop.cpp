...
void stop() {
    ...
    char buf[] = {0x1E, 0x10,0x10};
    MyCAN->doSendMsg(0x508,buf, 3,0x00); // brake
    time_sleep(0.01);
    
    char buf1[] = {0x1E, 0x70,0x00};
    MyCAN->doSendMsg(0x708,buf1, 3,0x00); // brake
    time_sleep(0.01);
    //roues
